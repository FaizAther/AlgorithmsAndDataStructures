...
public class DequeSampleTest {
    ...
    public void testReverseSingleElement() {
        ...
        deque.reverse();
        Assert.assertEquals(Integer.valueOf(5), deque.popLeft());
    }

    @Test
    public void sizeElementsArrayDeque() {
        Assert.assertEquals(2, arrayDeque.size());
    }

    @Test
    public void sizeElementsLinkedDeque() {
        Assert.assertEquals(2, linkedDeque.size());
    }
    ...
    public void peekLeftArrayDequeSingleElement() {
        ...
        Assert.assertEquals("hello", deque.peekLeft());
        Assert.assertEquals(priorSize, deque.size());
    }
